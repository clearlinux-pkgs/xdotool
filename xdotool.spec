...
Source0  : https://github.com/jordansissel/xdotool/releases/download/v3.20210903.1/xdotool-3.20210903.1.tar.gz
...
%prep
%setup -q -n xdotool-3.20210903.1
cd %{_builddir}/xdotool-3.20210903.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630885838
...
cp %{_builddir}/xdotool-3.20210903.1/COPYRIGHT %{buildroot}/usr/share/package-licenses/xdotool/529f17880a19f0a053c551e6ffc15e0f69ad6f89
